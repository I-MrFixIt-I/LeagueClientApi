...
{
    // More info: https://gist.github.com/baratgabor/06aef4815226eedc8ef5052e595b3ca4
    ...
    public static class InfoReader
    {
        ...
        public static THREAD_BASIC_INFORMATION GetTBI(Process process)
        {
            ...
            try
            {
                ...
                int result = NtQueryInformationThread(hThread, ThreadInfoClass.ThreadBasicInformation, out tbi, Marshal.SizeOf(tbi), IntPtr.Zero);
        ...
        public static extern int NtQueryInformationThread(IntPtr threadHandle, ThreadInfoClass threadInformationClass, out THREAD_BASIC_INFORMATION threadInformation, int threadInformationLength, IntPtr returnLengthPtr);
